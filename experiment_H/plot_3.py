...
fig = plt.figure()
x = [8, 7, 6, 5, 4, 3, 2, 1]
y = [11.53, 10.97, 10.23, 9.33, 8, 6.18, 4.26, 2.16]
xerr = [0.16, 0.14, 0.12, 0.1, 0.08, 0.06, 0.04, 0.02]
yerr = [0.17533562993584617, 0.1668197623934287, 0.15556665171237696, 0.14188043601920597, 0.1216552506059644, 0.09397868109310749, 0.06478142094767604, 0.032846917663610385]
