...
fig = plt.figure()
x1 = [8, 7, 6, 5, 4, 3, 2, 1]
y1 = [11.86, 11.23, 10.33, 9.61, 8.3, 6.39, 4.44, 2.21]
xerr1 = [0.16, 0.14, 0.12, 0.1, 0.08, 0.06, 0.04, 0.02]
yerr1 = [0.33, 0.31, 0.28, 0.27, 0.23, 0.18, 0.12, 0.06]
x2 = [8, 7, 6, 5, 4, 3, 2, 1]
y2 = [11.66, 10.93, 9.62, 9.44, 8.09, 6.28, 4.27, 2.3]
xerr2 = [0.16, 0.14, 0.12, 0.1, 0.08, 0.06, 0.04, 0.02]
yerr2 = [0.24, 0.23, 0.2, 0.2, 0.17, 0.13, 0.09, 0.05]
x3 = [8, 7, 6, 5, 4, 3, 2, 1]
y3 = [11.53, 10.97, 10.23, 9.33, 8, 6.18, 4.26, 2.16]
xerr3 = [0.16, 0.14, 0.12, 0.1, 0.08, 0.06, 0.04, 0.02]
yerr3 = [0.17533562993584617, 0.1668197623934287, 0.15556665171237696, 0.14188043601920597, 0.1216552506059644, 0.09397868109310749, 0.06478142094767604, 0.032846917663610385]
